...
const Home = () => {
  const [navToggleContext, setNavToggleContext] = useState(false);
  return (
    <AppContext.Provider value={{ navToggleContext, setNavToggleContext }}>
      <div className="h-screen overflow-y-scroll  hide-scrollbar">
        <div className="lg:grid grid-cols-12 grid-rows-12 ">
          {navToggleContext && (
            <div className="col-span-2  row-span-12 min-h-screen  bg-myBlack overflow-y-scroll  hide-scrollbar  animate-slide-down ">
              <Sidebar />
            </div>
          )}
